...
function Footer() {
  return (
    <div className='w-full relative h-[50vh] bg-[#838A60] mt-10 rounded-tl-2xl  rounded-tr-2xl'>
      <div className='max-w-screen-xl mx-auto flex items-center gap-32'>
       ...
       <IoLeaf size="3em" color='green'  />
        ...
        <div className='menu '>
          <h2 className='text-md mb-2 text-white font-[poppins] font-semibold'  >Menu</h2>
          <ul>
