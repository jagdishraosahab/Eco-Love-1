...
function Page6sale() {
  var raw = [
    ...
    { img: "https://img.freepik.com/free-photo/front-view-argan-product-composition_23-2148955780.jpg?t=st=1714750085~exp=1714753685~hmac=be84a4ddae32cce134221525b0002462b5ea132f224392452d6e92fc9780c974&w=360", text: "Organic Macadamia Body oil", price: "15", isLiked: false, isCart: false },
  ...
  return (
    <div className="w-full mt-20">
      <div className="max-w-screen-xl  mx-auto">
        ...
        <div className="saleboxctrl w-full mt-10 flex  overflow-x-scroll gap-20">
