  ...
  return (
    <div className="max-w-screen-xl relative select-none p-5  mx-auto">
      <div   className="lg:mt-5    flex items-center justify-between">
        ...
        <Link  to="/catlog" className=" absolute top-[80%] lg:top-[9%] lg:left-[67%] lg:block lg:py-4 lg:px-28 py-2 px-32  bg-[#838A60] rounded-xl text-lg lg:text-xl font-[poppins] text-white">
          Go To Catalog
        </Link >
      </div>
