...
function Page1() {
  ...
  return (
    <div className="max-w-screen-xl relative z-[2] p-5   mx-auto">
      <div   className="lg:mt-5 lg:relative lg:w-full lg:h-[13vh]    flex items-center justify-between">
        <motion.h1 animate={{y:0 , opacity:1}} initial={{y:100 , opacity:0}}  transition={{ease : "linear" , duration:0.3 , delay:0.3}} className="text-[4.9vh] lg:text-8xl font-[NewYork] uppercase text-[#838A60] ">
          Green City Style
        </motion.h1>
  ...
  <Link  to="/catlog" className="  absolute top-[80%] left-[1vh] mr-2 lg:mr-0 lg:top-[9%]  lg:left-[67%] lg:block lg:py-4 lg:px-[17vh] py-2 px-32  bg-[#838A60] rounded-xl text-lg lg:text-xl font-[Poppins] text-center text-white">
      ...
      <div    className=" lg:flex  items-center justify-between">
        <motion.p animate={{y:0 , opacity:1}}  initial={{y:100 , opacity:0}} transition={{ease : "linear" , duration:0.3 , delay:0.4}}
        ...
        <motion.h1 animate={{y:0 , opacity:1}}  initial={{y:100 , opacity:0}} transition={{ease : "linear" , duration:0.3 , delay:0.4}}
      ...
      <div className="w-full h-[52vh]   mt-10">
        <motion.div animate={{y:0 , opacity:1}}  initial={{y:100 , opacity:0}} transition={{ease : "linear" , duration:0.3 , delay:0.5}}
