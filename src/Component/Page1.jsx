  ...
  return (
    <div className="max-w-screen-xl relative  p-5   mx-auto">
      <div className="lg:mt-5 lg:relative lg:w-full lg:h-[13vh]    flex items-center justify-between">
        ...
        <Link
          to="/catlog"
          className="  absolute top-[80%] left-[1vh] mr-2 lg:mr-0 lg:top-[9%]  lg:left-[67%] lg:block lg:py-4 lg:px-[17vh] py-2 px-32  bg-[#838A60] rounded-xl text-lg lg:text-xl font-[Poppins] text-center text-white"
        >
          Go To Catalog
        </Link>
      </div>
